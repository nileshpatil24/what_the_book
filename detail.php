<?php session_start();
	...
	$res=mysqli_query($conn,$q) or die("Can't Execute Query..".mysqli_error($conn));
			...
			<!-- start page -->
				...
				<div id="page">
						<!-- start content -->
							...
							{
							echo '<td><i class="material-icons">add shopping car</i><br><a href="signin.php"> <h4>Please Login..</h4></a></td>';
							}
							echo '</tr>
						</table>';
					?>
